| folder      | author       | language | description                                                  |
| ----------- | ------------ | -------- | ------------------------------------------------------------ |
...
| vasp2xyz    | Yanzhou WANG, Yuwen ZHANG | Shell    | Create NEP training data in the extended XYZ format from the ugly formatted OUTCARs of VASP output |
| castep2xyz  | Yanzhou WANG | Shell	| Create NEP training data in the extended XYZ format from the ugly formatted castep output | 
