...
void Add_Random_Force::compute(const int step, const std::vector<Group>& groups, Atom& atom)
{
...
void Add_Random_Force::parse(const char** param, int num_param, const std::vector<Group>& group)
{
  printf("Add force.\n");
