...
static __device__ void apply_mic_small_box(
  const Box& box, const NEP3Cavity::ExpandedBox& ebox, double& x12, double& y12, double& z12)
{
  if (box.triclinic == 0) {
...
static __global__ void find_neighbor_list_small_box(
  ...
  const int N2,
  const Box box,
  const NEP3Cavity::ExpandedBox ebox,
...
static __global__ void find_descriptor_small_box(
  ...
  const double* __restrict__ g_x12_radial,
  const double* __restrict__ g_y12_radial,
  const double* __restrict__ g_z12_radial,
  const double* __restrict__ g_x12_angular,
  const double* __restrict__ g_y12_angular,
  const double* __restrict__ g_z12_angular,
