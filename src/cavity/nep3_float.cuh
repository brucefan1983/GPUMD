...
class NEP3Float : public PotentialFloat
{
public:
  struct ParaMB {
    int version = 2; // NEP version, 2 for NEP2 and 3 for NEP3Float
    int model_type =
  ...
  NEP3Float(const char* file_potential, const int num_atoms);
  virtual ~NEP3Float(void);
