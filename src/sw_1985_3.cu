...
(
    int number_of_particles, int pbc_x, int pbc_y, int pbc_z, SW3 sw3,
...
void gpu_find_force_sw3(Parameters *para, SW3 sw3, GPU_Data *gpu_data)
{
    int N = para->N;
