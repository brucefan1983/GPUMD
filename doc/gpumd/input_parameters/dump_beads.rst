...
Each file thus contains the data for one bead and the format is identical to the :ref:`dump.xyz output file <dump_xyz>` as generated by the :ref:`dump_xyz keyword <kw_dump_xyz>`.
