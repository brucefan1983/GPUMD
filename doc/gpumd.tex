...
\textcolor{red}{Rewrite this section after submitting a paper on NEMD.}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=0.8\columnwidth]{phonon_ex1.eps}
\caption{Phonon dispersion of silicon crystal calculated using the Tersoff-1989 potential. }
\label{figure:phonon_ex1}
\end{center}
\end{figure}

Figure \ref{figure:phonon_ex1} shows the phonon dispersion of silicon crystal calculated using the Tersoff-1989 potential. 
