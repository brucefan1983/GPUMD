...
The mass should be given in units of the unified atomic mass unit (amu). The cutoff distance, box lengths and atom coordinates should be given in units of angstrom (\AA). Velocities can be in arbitrary units because we will rescale them according to the initial temperature specified in the \verb"run.in" file (TODO).
