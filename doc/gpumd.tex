...
\begin{itemize}
\item column 1: correlation time (in units of ps)
\item column 2: RDC (in units of \AA$^2$/ps) in the $x$ direction
\item column 3: RDC (in units of \AA$^2$/ps) in the $y$ direction
\item column 4: RDC (in units of \AA$^2$/ps) in the $z$ direction
\end{itemize}
