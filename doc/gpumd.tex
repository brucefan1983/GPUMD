...
In the last term, $k$ can either be $j$ or not. When $k=j$, this term is
\begin{align}
...
\end{align}
We next derive expressions for $\frac{\partial  B_{ij}}{\partial \vect{r}_{ij}}$ and $\frac{\partial  B_{ik}}{\partial \vect{r}_{ij}}$ ($k\neq j$).

First consider $\frac{\partial  B_{ij}}{\partial \vect{r}_{ij}}$, which can be written as
\begin{align}
\frac{\partial  B_{ij}}{\partial \vect{r}_{ij}} = 
\frac{\partial  b_{ij}^{\sigma\pi}}{\partial \vect{r}_{ij}} +
\frac{\partial  \pi_{ij}^{RC}}{\partial \vect{r}_{ij}} +
\frac{\partial  \pi_{ij}^{DH}}{\partial \vect{r}_{ij}}.
\end{align}
We consider the three terms one by one.

For $\frac{\partial  b_{ij}^{\sigma\pi}}{\partial \vect{r}_{ij}}$, we have
\begin{align} 
\frac{\partial  b_{ij}^{\sigma\pi}}{\partial \vect{r}_{ij}} =
\frac{\partial  b_{ij}^{\sigma\pi}}{\partial \zeta_{ij}} \frac{\partial  \zeta_{ij}^{\sigma\pi}}{\partial \vect{r}_{ij}}.
\end{align}
where
\begin{align} 
\frac{\partial  \zeta_{ij}^{\sigma\pi}}{\partial \vect{r}_{ij}} = 
...
\end{align}
Because $N_{ij}$ does not depend on $\vect{r}_{ij}$, we can simplify the above equation:
\begin{align} 
\frac{\partial  \zeta_{ij}^{\sigma\pi}}{\partial \vect{r}_{ij}} = 
