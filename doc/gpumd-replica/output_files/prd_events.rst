...
* The final three columns give the selected quenched configuration's total potential energy (eV), largest absolute force component among the :math:`3N` force components (eV/Angstrom), and minimization steps.
